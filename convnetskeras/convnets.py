...
def AlexNet(weights_path=None, heatmap=False):
    ...
    conv_1 = Convolution2D(96, 11, 11, subsample=(4, 4), activation='relu', data_format='channels_first',
                           name='conv_1')(inputs)
    ...
    conv_2 = merge([
                       Convolution2D(128, 5, 5, activation='relu', data_format='channels_first', name='conv_2_' + str(i + 1))(
    ...
    conv_3 = Convolution2D(384, 3, 3, activation='relu', data_format='channels_first', name='conv_3')(conv_3)

    conv_4 = ZeroPadding2D((1, 1))(conv_3)
    conv_4 = merge([
                       Convolution2D(192, 3, 3, activation='relu', data_format='channels_first', name='conv_4_' + str(i + 1))(
                           splittensor(ratio_split=2, id_split=i)(conv_4)
                       ) for i in range(2)], mode='concat', concat_axis=1, name='conv_4')

    conv_5 = ZeroPadding2D((1, 1))(conv_4)
    conv_5 = merge([
                       Convolution2D(128, 3, 3, activation='relu', data_format='channels_first', name='conv_5_' + str(i + 1))(
    ...
    if heatmap:
        dense_1 = Convolution2D(4096, 6, 6, activation='relu', data_format='channels_first', name='dense_1')(dense_1)
        dense_2 = Convolution2D(4096, 1, 1, activation='relu', data_format='channels_first', name='dense_2')(dense_1)
        dense_3 = Convolution2D(1000, 1, 1, data_format='channels_first', name='dense_3')(dense_2)
